...
const LOCALES = {
  en: {
    ...
    _label: 'English',
    _speech: 'en-US',
    titlebar_global_workspace: 'Global workspace',
    titlebar_local_user: 'Local',
    titlebar_user_settings: 'User settings',
    titlebar_logout: 'Log out',
    titlebar_running_chats_keep_workspace: 'Global workspace updated. Running chats keep their workspace.',
    // boot.js
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    workflow_new_definition: 'New workflow',
    workflow_empty_title: 'Select a workflow',
    workflow_empty_sub: 'Pick a workflow definition to edit, publish, run, and review evidence.',
    tab_assistant: 'My Assistant',
    ...
    cron_schedule_mode_daily: 'Daily',
    cron_schedule_mode_weekly: 'Weekly',
    cron_schedule_mode_interval: 'Interval',
    cron_schedule_mode_custom: 'Custom',
  ...
  es: {
    ...
    _label: 'Español',
    _speech: 'es-ES',
    titlebar_global_workspace: 'Espacio global',
    titlebar_local_user: 'Local',
    titlebar_user_settings: 'Ajustes de usuario',
    titlebar_logout: 'Cerrar sesión',
    titlebar_running_chats_keep_workspace: 'Espacio global actualizado. Los chats en ejecución conservan su espacio.',
    // boot.js
  ...
  zh: {
    ...
    _label: '\u7b80\u4f53\u4e2d\u6587',
    _speech: 'zh-CN',
    titlebar_global_workspace: '全局工作区',
    titlebar_local_user: '本地',
    titlebar_user_settings: '用户设置',
    titlebar_logout: '退出登录',
    titlebar_running_chats_keep_workspace: '全局工作区已更新。运行中的会话会保留原工作区。',
    // boot.js
    cancelling: '正在取消...',
    cancel_failed: '取消失败：',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    workflow_new_definition: '新建工作流',
    workflow_empty_title: '选择一个工作流',
    workflow_empty_sub: '从列表中选择工作流定义，进行编辑、发布、运行并查看证据追踪。',
    tab_kanban: '看板',
    kanban_board: '看板',
    ...
    cron_schedule_mode_daily: '每天',
    cron_schedule_mode_weekly: '每周',
    cron_schedule_mode_interval: '间隔',
    cron_schedule_mode_custom: '自定义',
